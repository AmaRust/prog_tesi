...
def plot_metrics(data, situation, title):
    param_values = [entry["parameters"]["overlap"] for entry in data]
...
def add_constant_parameters_page(pdf, data):
    ...
    del constant_parameters["overlap"]
...
if __name__ == "__main__":
    ...
    json_file = "../json_result_files/overlap/results_overlap_config_query.json" 
    ...
    if os.path.isfile(os.path.join("../json_result_files", json_file)):
        ...
        pdf_filename = "pdf_files/overlap/overlap_graphs.pdf"
    ...
    json_file = "../json_result_files/overlap/results_overlap_config_queries.json"

    if os.path.isfile(os.path.join("../json_result_files", json_file)):
        with open(json_file, 'r') as f:
            data = json.load(f)

        pdf_filename = "pdf_files/overlap/overlap_graphs_queries.pdf"
